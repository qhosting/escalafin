  ...
  return (
    <TooltipProvider>
      <div className="space-y-4 pb-20 md:pb-6">
        ...
        {/* KPIs — Tarjetas Métricas Fintech */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2.5 sm:gap-3">
          
          {/* Card: Total */}
          <Card className="border border-blue-100/80 dark:border-blue-900/40 bg-gradient-to-br from-white to-blue-50/30 dark:from-gray-900 dark:to-blue-950/10 shadow-xs hover:shadow-sm transition-all duration-200 rounded-2xl">
          ...
          {/* Card: Activos */}
          <Card className="border border-emerald-100/80 dark:border-emerald-900/40 bg-gradient-to-br from-white to-emerald-50/30 dark:from-gray-900 dark:to-emerald-950/10 shadow-xs hover:shadow-sm transition-all duration-200 rounded-2xl">
            <CardContent className="p-3.5">
              <div className="flex items-center justify-between mb-1.5">
              ...
              <p className="text-[11px] font-medium text-emerald-600 dark:text-emerald-400 mt-0.5">
                {stats.totalClients > 0 ? `${Math.round((stats.activeClients / stats.totalClients) * 100)}% de la cartera` : 'Operando normalmente'}
              </p>
            </CardContent>
          </Card>

          {/* Card: Préstamos */}
          <Card className="border border-purple-100/80 dark:border-purple-900/40 bg-gradient-to-br from-white to-purple-50/30 dark:from-gray-900 dark:to-purple-950/10 shadow-xs hover:shadow-sm transition-all duration-200 rounded-2xl">
            <CardContent className="p-3.5">
              <div className="flex items-center justify-between mb-1.5">
          ...
          {/* Card: Cartera */}
          <Card className="border border-amber-100/80 dark:border-amber-900/40 bg-gradient-to-br from-white to-amber-50/30 dark:from-gray-900 dark:to-amber-950/10 shadow-xs hover:shadow-sm transition-all duration-200 rounded-2xl">
            <CardContent className="p-3.5">
              <div className="flex items-center justify-between mb-1.5">
          ...
          {/* Card: Score */}
          <Card className="border border-indigo-100/80 dark:border-indigo-900/40 bg-gradient-to-br from-white to-indigo-50/30 dark:from-gray-900 dark:to-indigo-950/10 shadow-xs hover:shadow-sm transition-all duration-200 rounded-2xl col-span-2 sm:col-span-1">
            <CardContent className="p-3.5">
              <div className="flex items-center justify-between mb-1.5">
              ...
              <p className="text-[11px] font-medium text-gray-500 dark:text-gray-400 mt-0.5">
                {stats.avgCreditScore >= 680 ? 'Calificación Excelente' : stats.avgCreditScore >= 550 ? 'Calificación Media' : 'Puntaje de riesgo'}
              </p>
            </CardContent>
          </Card>
        </div>
